...
# error from next line
    ...
    # '/Users/ryan0\OneDrive\Desktop\WebsiteBuilder\Wizardzaron.github.io'
...
def login():
    ...
    #if we are here then log in worked and the token is created
    rows = list()
   ...
   #     conn.close()
    ...
    #the reason why we do user_image/ instead of /user_image/ is beacuase this is the web path and not the file path
    pathToImage = 'user_image/'
...
#this creates a path to the directory
